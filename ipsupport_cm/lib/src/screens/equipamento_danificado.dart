...
/// The `DamagedEquipment` class is a StatefulWidget that allows users to report damaged equipment,
/// including selecting the type of damage, providing a description, uploading a photo, and marking the
/// issue as urgent.
  ...
  void report() async {
    ...
    for (var i = 0; i < reportsList.length; i++) {
      if (reportsList[i].reportData!.resolutionDate == "Not resolved") {
        if (reportsList[i].reportData!.problem == "Equipamento" &&
